                    ...
                    <div class="col-md-12 col-md-offset-2">
                        ...
                        <!-- <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <form class="" action="{{ route('order.done') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }} 
                                    {{method_field('PATCH')}}
                                    <td><button type="submit"  class="btn btn-outline-success" value="save">Selesai</button></td>
                                </form>
                                </tr>
                            @endif
							@endforeach
